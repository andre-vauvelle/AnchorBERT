...
#$ -l h_vmem=8G,tmem=8G,tscratch=1G
...
for trial in $(seq 0 "$TRIALS"); do
  ...
  /share/apps/genomics/plink-2.0/bin/plink2 --1 \
    ...
    --pheno /SAN/ihibiobank/denaxaslab/andre/UKBB/data/processed/phenotypes/"$PHENO_DIR"/"$trial".tsv \
