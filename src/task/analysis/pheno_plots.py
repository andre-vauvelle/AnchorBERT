...
if __name__ == '__main__':
    ...
    name = 'bert_250.2.tsv'
    # name = 'all_250.2.tsv'
    # df = pd.read_csv('/SAN/ihibiobank/denaxaslab/andre/UKBB/data/processed/phenotypes/{}'.format(name), sep='\t')
    # df_a = pd.read_csv('/SAN/ihibiobank/denaxaslab/andre/UKBB/data/processed/phenotypes/all_anchor_714.0|714.1.tsv', sep='\t')
    # df = pd.read_csv('/SAN/ihibiobank/denaxaslab/andre/UKBB/data/processed/phenotypes/bert_250.2.tsv.tsv', sep='\t')
